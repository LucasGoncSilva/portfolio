...
p1 = f'Com 17 anos de idade, adentrei o universo da programação em abril de 2021, sempre estudando de maneira consistente e sólida. Inicialmente, iniciei como autodidata, utilizando ferramentas como Youtube, StackOverFlow e alguns cursos; atualmente estou cursando Ciência da Computação no {period} semestre.'

...
vmap: Project = Project(
    "VMAP",
    "Ferramenta de controle e mapeamento de deploy em cenários reais em Django. Collab",
    "https://github.com/LucasGoncSilva/vmap/",
)
bookery: Project = Project(
    "Bookery",
    "Sistema de gerenciamento Desktop e API de livros para bibliotecas com Axum e Tauri.",
    "https://github.com/LucasGoncSilva/bookery/",
)
soon: Project = Project(
    "Em Breve",
    "Projeto em fase de planejamento teórico, avaliando oportunidades. Mais informações em breve.",
    "#",
)

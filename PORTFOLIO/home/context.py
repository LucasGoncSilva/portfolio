...
postgres: Skill = Skill('postgres', 'PostgreSQL', 'https://www.postgresql.org/', 'O Mais Avançado Banco de Dados do Mundo, o Postgres, é um sistema de gerenciamento de banco de dados relacional e objeto-relacional de código aberto. Ele é amplamente utilizado por sua robustez, extensibilidade e conformidade com os padrões SQL. Seus diferenciais incluem suporte avançado a transações ACID, extensões personalizadas e uma comunidade ativa de desenvolvimento.')
rust: Skill = Skill('rust', 'Rust', 'https://www.rust-lang.org/pt-BR/', 'Rust é uma linguagem de programação moderna, focada em segurança, desempenho e concorrência. Projetada para evitar falhas de segmentação e condições de corrida, ela combina a eficiência do C++ com garantias de segurança de memória. Rust é popular por sua sintaxe expressiva, sistema de tipos avançado e a capacidade de gerenciar memória sem um coletor de lixo.')
...
swarden: Project = Project('sWarden', 'Gerenciador de Senhas online com criptografia de banco em Django e Sass.', 'https://github.com/LucasGoncSilva/swarden/')
...
vmap: Project = Project('VMAP', 'Ferramenta de controle e mapeamento de deploy em cenários reais em Django.\nCollab', 'https://github.com/LucasGoncSilva/vmap/')
